...
{
    public partial class ThirdGroup : PhoneApplicationPage
    {
        int a, a1, a2,
            b, b1, b2,
            c, c1, c2,
        ...
        {
            if (riy1.Text == "" || riy2.Text == "" || riy3.Text == "" || istor1.Text == "" || istor2.Text == "" || istor3.Text == "" || rus1.Text == "" || rus2.Text == "" || rus3.Text == "" || literat1.Text == "" || literat2.Text == "" || eng1.Text == "" || eng2.Text == "")
            {
            ...
            b = Convert.ToInt32(istor1.Text);
            b1 = Convert.ToInt32(istor2.Text);
            b2 = Convert.ToInt32(istor3.Text);
            c = Convert.ToInt32(rus1.Text);
            c1 = Convert.ToInt32(rus2.Text);
            c2 = Convert.ToInt32(rus3.Text);
            d = Convert.ToInt32(literat1.Text);
            d1 = Convert.ToInt32(literat2.Text);
            ...
            result.Text = (RezultatOtkritix(a, a1, a2) + RezultatOtkritix(b, b1, b2) * 2 + RezultatOtkritix(c, c1, c2) * 2 + RezultatZakritix(d, d1) + RezultatZakritix(f, f1)).ToString();
            nisb_Riy.Text = RezultatOtkritix(a, a1, a2).ToString();
            nisb_Istor.Text = RezultatOtkritix(b, b1, b2).ToString();
            nisb_Rus.Text = RezultatOtkritix(c, c1, c2).ToString();
            nisb_Liter.Text = RezultatZakritix(d, d1).ToString();
            ...
            {
                new LineData { Category = "E1", Line1 = RezultatOtkritix(a, a1, a2)},
                new LineData { Category = "E2", Line1 = RezultatOtkritix(b, b1, b2)*2},
                new LineData { Category = "E3", Line1 = RezultatOtkritix(c, c1, c2)*2},
