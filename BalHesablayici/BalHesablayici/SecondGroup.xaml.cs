...
{
    public partial class SecondGroup : PhoneApplicationPage
    {
        int a, a1, a2,
            b, b1, b2,
            c, c1, c2,
        ...
        {
            if (riy1.Text == "" || riy2.Text == "" || riy3.Text == "" || geogr1.Text == "" || geogr2.Text == "" || geogr3.Text == "" || rus1.Text == "" || rus2.Text == "" || rus3.Text == "" || istor1.Text == "" || istor2.Text == "" || eng1.Text == "" || eng2.Text == "")
            {
            ...
            b = Convert.ToInt32(geogr1.Text);
            b1 = Convert.ToInt32(geogr2.Text);
            b2 = Convert.ToInt32(geogr3.Text);
            c = Convert.ToInt32(rus1.Text);
            c1 = Convert.ToInt32(rus2.Text);
            c2 = Convert.ToInt32(rus3.Text);
            d = Convert.ToInt32(istor1.Text);
            d1 = Convert.ToInt32(istor2.Text);
            ...
            nisb_Geogr.Text = RezultatOtkritix(b, b1, b2).ToString();
            nisb_Rus.Text = RezultatOtkritix(c, c1, c2).ToString();
            nisb_Istor.Text = RezultatZakritix(d, d1).ToString();
