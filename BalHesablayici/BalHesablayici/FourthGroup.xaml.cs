...
{
    public partial class FourthGroup : PhoneApplicationPage
    {
        int a, a1, a2,
            b, b1, b2,
            c, c1, c2,
        ...
        {
            if (riy1.Text == "" || riy2.Text == "" || riy3.Text == "" || xim1.Text == "" || xim2.Text == "" || xim3.Text == "" || fiz1.Text == "" || fiz2.Text == "" || fiz3.Text == "" || rus1.Text == "" || rus2.Text == "" || biolog1.Text == "" || biolog2.Text == "")
            {
            ...
            b = Convert.ToInt32(xim1.Text);
            b1 = Convert.ToInt32(xim2.Text);
            b2 = Convert.ToInt32(xim3.Text);
            c = Convert.ToInt32(fiz1.Text);
            c1 = Convert.ToInt32(fiz2.Text);
            c2 = Convert.ToInt32(fiz3.Text);
            d = Convert.ToInt32(rus1.Text);
            d1 = Convert.ToInt32(rus2.Text);
            f = Convert.ToInt32(biolog1.Text);
            f1 = Convert.ToInt32(biolog2.Text);
            ...
            nisb_Xim.Text = RezultatOtkritix(b, b1, b2).ToString();
            nisb_Fiz.Text = RezultatOtkritix(c, c1, c2).ToString();
            nisb_Rus.Text = RezultatZakritix(d, d1).ToString();
            nisb_Biolog.Text = RezultatZakritix(f, f1).ToString();
